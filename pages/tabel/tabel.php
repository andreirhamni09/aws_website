...
if (empty($_GET['tanggalAwal']) && empty($_GET['tanggalAkhir'])) {
    $tsql = "SELECT * FROM tabel_aws1 ORDER BY tanggal ASC";

    //--tanggal kecil
    $tanggalKecil = "SELECT * FROM tabel_aws1 ORDER BY tanggal ASC LIMIT 1";
    $result_tA =  mysqli_query($tkon, $tanggalKecil);
    while ($row_ta = mysqli_fetch_array($result_tA)) {
        $tanggalAwal = $row_ta['tanggal'];
    }
    //--tanggal besar

    $tanggalBesar = "SELECT * FROM tabel_aws1 ORDER BY tanggal DESC LIMIT 1";
    ...
    $tsql = "SELECT * FROM tabel_aws1 WHERE tanggal BETWEEN '$tanggalAwal' AND '$tanggalAkhir' OR tanggal BETWEEN '$tanggalAkhir' AND '$tanggalAwal' ORDER BY tanggal ASC";
}
...
<head>
    ...
    <title>Data AWS <?php echo $nameTabel; ?></title>
...
<body class="hold-transition sidebar-mini sidebar-collapse layout-fixed layout-navbar-fixed">
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body table-responsive ">
                                    <table id="tabeldata" class="table table-bordered table-hover text-center">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Tanggal</th>
    ...
    <footer class="main-footer">
        ...
        <strong><a href="#">AWS</a>.</strong> Rubah dolo
    </footer>   
    <!-- ./wrapper -->
